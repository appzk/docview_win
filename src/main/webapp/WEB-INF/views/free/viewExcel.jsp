...
<section class="container clearfix">
	...
	<div class="excel-body-container">
			...
			<c:forEach items="${page.data}" var="vo" varStatus="status">
				<c:choose>
					<c:when test="${status.count=='1'}">
						<li class="active"><a href="#tab${status.count}"><c:out value="${vo.title}"></c:out></a></li>
					</c:when>
					<c:otherwise>
						<li><a href="#tab${status.count}"><c:out value="${vo.title}"></c:out></a></li>
					</c:otherwise>
				</c:choose>
			</c:forEach>
		...
		<div class="tabs-container">
			...
			<c:forEach items="${page.data}" var="vo" varStatus="status">
				<div class="tab-content" id="tab${status.count}">
