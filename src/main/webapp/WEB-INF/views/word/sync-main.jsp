...
<html lang="en">
  ...
  <body class="ppt-body">
    ...
    <div class="container-fluid" style="max-height: 100%;">
      <div class="row-fluid">
        ...
        <div class="span12">
          <br />
          <h4>说明</h4>
          1. 在一个小组或一个会场进行word同步在线预览。演讲者翻页、画笔标记等都会同步展示到听众的终端浏览器页面；<br />
          2. 演讲者进入演讲视图，听众进入听众视图。演讲者或听众都可以使用手机、平板或电脑等终端设备。通过扫描二维码或直接在浏览器输入对应网址进入对应视图。
        </div>
      </div>
    ...
    <script src="/static/idocv/js/word-sync-main.js?v=${version}"></script>
