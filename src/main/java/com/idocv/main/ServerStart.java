...
/**
 * TT 服务启动类，负责启动web Server服务 服务使用Jetty为容器，采用Spring 3中的Java
 * Config方式通过TTServerConfig类进行依赖注入配置
...
public class ServerStart {
	...
	public static ServerStart srvStart;//全局唯一Start类
	...
	public static void main(String[] args) {
		...
		srvStart = cntxt.getBean(ServerStart.class);
		try {
